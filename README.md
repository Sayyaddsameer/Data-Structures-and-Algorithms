...
Welcome. [cite_start]This repository is my curated library of Data Structures and Algorithms, built from the `DSA RoadMap`[cite: 1]. It serves as a living project dedicated to designing, implementing, and documenting the "blueprints" of efficient software.

[cite_start]My goal is to build a comprehensive reference that emphasizes code clarity, algorithmic efficiency, and practical application by solving problems from platforms like LeetCode and GeeksforGeeks[cite: 14, 16].

[cite_start]**Primary Language:** `[Your Primary Language, e.g., Python/Java]` 

---

## What is a Data Structure?

A **Data Structure** is a specialized format for organizing, processing, retrieving, and storing data. [cite_start]Just as an architect designs different blueprints for a skyscraper versus a house, a programmer chooses different data structures (like `Arrays`, `Linked Lists`, or `Trees` [cite: 6]) to build efficient software. The choice of data structure dictates how data is accessed and what operations can be performed on it.

## What is an Algorithm?

An **Algorithm** is a finite sequence of well-defined, computer-implementable instructions, typically to solve a class of problems or to perform a computation. [cite_start]If a data structure is the "blueprint," the algorithm is the "set of instructions" (like `Binary Search` or `Merge Sort` [cite: 8]) that explains how to build or use the blueprint to achieve a specific goal.
...
* [cite_start]**Key Concepts (from my roadmap):** Prefix Sum, Sliding Window, Kadane’s Algorithm[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Palindromes, Anagrams, Pattern Matching[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Balanced Parentheses, Next Greater Element, Monotonic Stack[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Reversal, Merge, Detect Cycle (Floyd's Algorithm)[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Count Frequency, Two Sum, Subarray Sum[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Inorder/Preorder/Postorder Traversal, Height, Diameter, Lowest Common Ancestor (LCA)[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** Min/Max Heap, K Largest/Smallest Elements[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** BFS (Breadth-First Search), DFS (Depth-First Search), Connected Components[cite: 6].
* [cite_start]**Advanced Algorithms:** Dijkstra's, Bellman-Ford, Prim’s, Kruskal’s[cite: 8].
...
* [cite_start]**Key Algorithms:** Binary Search, Merge Sort, Quick Sort[cite: 8].
...
* [cite_start]**Key Concepts (from my roadmap):** Subsets, Permutations, N-Queens[cite: 6].
...
* [cite_start]**Key Concepts (from my roadmap):** 0/1 Knapsack, Longest Increasing Subsequence (LIS), Fibonacci, DP on Grids[cite: 6].
* [cite_start]**Approaches:** Memoization (Top-Down) and Tabulation (Bottom-Up)[cite: 8].
...
* [cite_start]**Key Concepts (from my roadmap):** Activity Selection, Huffman Encoding[cite: 8].
...
## 🗓️ My Weekly Study Plan

This repository follows the structured learning path from my roadmap.

| Week | What to Focus On |
| :--- | :--- |
| 1-2 | [cite_start]Arrays, Strings, Recursion [cite: 10] |
| 3-4 | [cite_start]Linked Lists, Stacks & Queues, TOC Unit 1–2 [cite: 10] |
| 5-6 | [cite_start]Trees, Hashing, TOC Unit 3–4 [cite: 10] |
| 7-8 | [cite_start]Graphs, Backtracking, TOC Unit 5 [cite: 10] |
| 9-10 | [cite_start]DP, Heaps, TOC Unit 6 [cite: 10] |
| 11+ | [cite_start]Solve 150+ Leetcode DSA questions [cite: 10] |
